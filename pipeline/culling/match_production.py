#!/usr/bin/env python3
"""Match production_final.csv rows back to /originals files via metadata.db (READ-ONLY)."""
import csv, os, re, sqlite3, sys, json

DB = "/home/david/loupe-pipeline/metadata.db"
CSV_IN = "/home/david/loupe-pipeline/culling/production_final.csv"
...
json.dump(results, open("/home/david/loupe-pipeline/culling/_match_results.json","w"), indent=1)
print("wrote culling/_match_results.json")
